...
public class DragAbleView extends View {
    ...
    private DragAbleView.ViewCallBack callBack = null;//回调

    public DragAbleView(Context context,DragAbleView.ViewCallBack callBack) {
        super(context);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP://触摸离开动作
                ...
                this.invalidate();
                if(downX == x&&downY==y){
                    callBack.finshActivity(context);
                }
                break;
